...
class TestSubmitExamAnswers:
    def test_candidate_submit_exam_answers_success(self, api_client, submit_exam_answers_url, create_logged_in_screening_candidate):
        ...
        response = api_client.post(submit_exam_answers_url(exam.id), candidate_answers_data, format="json")
    ...
    def test_candidate_duplicate_submit_exam_answers_fail(self, api_client, submit_exam_answers_url, create_logged_in_screening_candidate):
        ...
        api_client.credentials(HTTP_AUTHORIZATION=f"Bearer {access}")
        api_client.post(submit_exam_answers_url(exam.id), candidate_answers_data, format="json")
        response = api_client.post(submit_exam_answers_url(exam.id), candidate_answers_data, format="json")
        assert response.status_code == 400
        assert "You have already submitted answers for this exam." in response.data["message"]